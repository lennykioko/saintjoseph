    ...
    <article>
      <div className="flex flex-col sm:flex-row gap-6 sm:gap-7 items-start mb-8">
        <div className="shrink-0 w-32 sm:w-36 mx-auto sm:mx-0">
          <div className="relative aspect-3/5 rounded-md overflow-hidden ring-1 ring-border shadow-sm bg-accent-soft">
            <Image
              src="/saintjoseph.png"
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[13px] font-bold uppercase tracking-[0.12em] text-text-muted mb-3">
            A 33-Day Consecration
          </div>
          <h1 className="text-[clamp(2.25rem,3vw+1rem,3rem)] font-extrabold leading-[1.1] text-accent tracking-tight mb-4">
      ...
      >
        <h2
          ...
          className="text-[13px] font-bold uppercase tracking-[0.12em] text-text-muted mb-4"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[180px_1fr] gap-4 items-start">
          ...
          <VideoCard
            videoId="qnAiDs1Uje4"
            title="St. Joseph & Spiritual Warfare with Fr. Donald Calloway"
            author="The Catholic Talk Show"
            thumbnail="https://i.ytimg.com/vi/qnAiDs1Uje4/hqdefault.jpg"
      ...
      <section className="mt-10">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="/introduction" className="text-accent underline underline-offset-2">
              Read Bishop Battersby&rsquo;s introduction
            </Link>
          </li>
          <li>
            <Link href="/day/1" className="text-accent underline underline-offset-2">
              Start with Day 1 — Noble Offspring of David
            </Link>
          </li>
          <li>
            <Link href="/litany" className="text-accent underline underline-offset-2">
